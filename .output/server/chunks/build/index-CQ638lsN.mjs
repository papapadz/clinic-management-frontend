globalThis.__timing__.logStart('Load chunks/build/index-CQ638lsN');import { _ as _sfc_main$1, u as useApi } from './useApi-BqLSQQg_.mjs';
...
function useImaging() {
  ...
  async function fetchRequests(params = {}) {
    ...
    error.value = null;
    try {
      const res = await api.api(api.tenantPath("/imaging/requests"), { params });
      if (res.success) {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const search = ref("");
    const { requests, loading, error, fetchRequests } = useImaging();
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_PageHeader, {
        ...
        description: "Follow imaging orders by modality, priority, and reporting status."
      }, null, _parent));
      if (unref(error)) {
      ...
      _push(ssrRenderComponent(_component_SearchToolbar, {
        ...
        label: "Search imaging requests"
      }, null, _parent));
      _push(ssrRenderComponent(_component_DataTable, {
        columns,
        rows: unref(requests),
        loading: unref(loading),
        "empty-title": "No imaging requests found",
        "empty-description": "Imaging requests will appear here after they are ordered."
      }, {
        ...
        "cell-actions": withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_BaseButton, {
              to: `/${unref(route).params.tenant}/imaging/${row.id}`,
              variant: "outline",
              size: "sm"
            }, {
        ...
        "mobile-card": withCtx(({ row }, _push2, _parent2, _scopeId) => {
          var _a, _b;
          if (_push2) {
            _push2(`<div class="flex items-start justify-between gap-3"${_scopeId}><div${_scopeId}><p class="font-bold"${_scopeId}>${ssrInterpolate(((_a = row.patient) == null ? void 0 : _a.full_name) || row.patient_id)}</p><p class="mt-1 text-xs text-muted-foreground"${_scopeId}>${ssrInterpolate(row.modality)} \u2022 ${ssrInterpolate(row.body_part)}</p></div>`);
            _push2(ssrRenderComponent(_component_StatusBadge, {
              status: row.priority
            }, null, _parent2, _scopeId));
            _push2(`</div>`);
            ...
            return [
              createVNode("div", { class: "flex items-start justify-between gap-3" }, [
                createVNode("div", null, [
                  ...
                  createVNode("p", { class: "mt-1 text-xs text-muted-foreground" }, toDisplayString(row.modality) + " \u2022 " + toDisplayString(row.body_part), 1)
                ]),
                createVNode(_component_StatusBadge, {
                  status: row.priority
                }, null, 8, ["status"])
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/[tenant]/imaging/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };;globalThis.__timing__.logEnd('Load chunks/build/index-CQ638lsN');
//# sourceMappingURL=index-CQ638lsN.mjs.map
