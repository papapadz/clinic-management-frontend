globalThis.__timing__.logStart('Load chunks/build/server');import { hasInjectionContext, inject, getCurrentInstance, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, useSlots, Fragment, defineAsyncComponent, computed, unref, shallowReactive, ref, Suspense, createApp, reactive, toRaw, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, effectScope, watch, toRef, mergeProps, getCurrentScope, withCtx, nextTick, toValue, onScopeDispose, isReadonly, useSSRContext, isRef, isShallow, isReactive } from 'vue';
import { q as hasProtocol, s as isScriptProtocol, u as joinURL, F as withQuery, x as sanitizeStatusCode, j as getContext, $ as $fetch$1, f as defu, b as createHooks, a as createError$1, i as executeAsync, c as createDebugger, B as toRouteMatcher, d as createRouter$1, v as klona, m as getRequestHeader, h as destr, r as isEqual, y as setCookie, k as getCookie, g as deleteCookie } from '../_/nitro.mjs';
...
const _routes = [
  {
    ...
    component: () => import('./login-CxaWUKYp.mjs')
  },
  {
    name: "tenant-lab",
    path: "/:tenant()/lab",
    component: () => import('./index-5J89rG2r.mjs')
  },
  {
    name: "tenant-billing",
    path: "/:tenant()/billing",
    component: () => import('./index-B6pLw9s2.mjs')
  },
  {
    name: "tenant-imaging",
    path: "/:tenant()/imaging",
    component: () => import('./index-CQ638lsN.mjs')
  },
  {
    name: "tenant-records",
    path: "/:tenant()/records",
    component: () => import('./index-CVICTKKS.mjs')
  },
  {
    name: "tenant-reports",
    path: "/:tenant()/reports",
    component: () => import('./index-B4AeOuWB.mjs')
  },
  {
    name: "tenant-patients",
    path: "/:tenant()/patients",
    meta: { "middleware": ["auth", "tenant"] },
    component: () => import('./index-Duo-a2NB.mjs')
  },
  {
    name: "tenant-pharmacy",
    path: "/:tenant()/pharmacy",
    component: () => import('./index-C7_w1An3.mjs')
  },
  {
    name: "tenant-settings-roles",
    path: "/:tenant()/settings/roles",
    component: () => import('./roles-DPLbXx_Q.mjs')
  },
  {
    name: "tenant-settings-users",
    path: "/:tenant()/settings/users",
    component: () => import('./users-jQ5CbCkN.mjs')
  },
  {
    name: "tenant-dashboard",
    path: "/:tenant()/dashboard",
    component: () => import('./index-D8H5yh39.mjs')
  },
  {
    name: "tenant-settings-clinic",
    path: "/:tenant()/settings/clinic",
    component: () => import('./clinic-DZANs3-K.mjs')
  },
  {
    name: "tenant-laboratory",
    path: "/:tenant()/laboratory",
    component: () => import('./index-Dp_8L9SX.mjs')
  },
  {
    name: "tenant-appointments",
    path: "/:tenant()/appointments",
    component: () => import('./index-B5L7NHlw.mjs')
  },
  {
    name: "tenant-patients-id",
    path: "/:tenant()/patients/:id()",
    meta: { "middleware": ["auth", "tenant"] },
    component: () => import('./index-2vPk_-cb.mjs')
  },
  {
    name: "tenant-patients-id-encounters-encId",
    path: "/:tenant()/patients/:id()/encounters/:encId()",
    meta: { "middleware": ["auth", "tenant"] },
    component: () => import('./_encId_-96QI_D6J.mjs')
  }
];
...
const namedMiddleware = {
  auth: () => import('./auth-CggV4mI4.mjs'),
  role: () => import('./role-BQGfBqME.mjs'),
  tenant: () => import('./tenant-BchwZ1N0.mjs')
};
...
function normalizeNameList(preferred, fallback) {
...
const api_jy9dy79pM_nYQuRKPrcfNg56p_gKkzw9SekUTZgAenc = /* @__PURE__ */ defineNuxtPlugin(() => {
  ...
  function tenantPath(path) {
    var _a;
    const tenant = ((_a = tenantStore.currentTenant) == null ? void 0 : _a.slug) ?? config.public.defaultTenant;
...
const layouts = {
  auth: defineAsyncComponent(() => import('./auth-CE8hgz-a.mjs').then((m) => m.default || m)),
  default: defineAsyncComponent(() => import('./default-BLLq1LpG.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CCqPbl8B.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-de7xO1Rx.mjs'));
...
export { _export_sfc as _, nuxtLinkDefaults as a, useHead as b, useNuxtApp as c, defineNuxtRouteMiddleware as d, entry_default as default, useRouter as e, useRuntimeConfig as f, useTenantStore as g, navigateTo as n, resolveRouteObject as r, useAuthStore as u };;globalThis.__timing__.logEnd('Load chunks/build/server');
