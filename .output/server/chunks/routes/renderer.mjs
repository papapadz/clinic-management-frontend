...
import { t as joinRelativeURL, E as useRuntimeConfig, o as getResponseStatusText, n as getResponseStatus, e as defineRenderHandler, l as getQuery, a as createError, p as getRouteRules, D as useNitroApp } from '../_/nitro.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Multi-tenant Clinic Management System"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"},{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&display=swap"}],"style":[],"script":[],"noscript":[],"title":"ClinicMS - Clinic Management System"};
...
export { baseURL as b, headSymbol as h, renderer$1 as r, useHead as u };;globalThis.__timing__.logEnd('Load chunks/routes//renderer');
